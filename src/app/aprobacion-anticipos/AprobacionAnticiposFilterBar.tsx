...
export function AprobacionAnticiposFilterBar({
  ...
  const [barColumns, setBarColumns] = useState<AproAntFilterColumn[]>([]);
  const [autoOpenColumn, setAutoOpenColumn] = useState<AproAntFilterColumn | null>(
    null,
  );
  ...
  const removeBarColumn = (col: AproAntFilterColumn) => {
