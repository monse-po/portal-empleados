#!/usr/bin/env bash
# Avisa al espacio de Google Chat que OCI PROD ya está desplegado.
# Uso:
...
PROD_URL="${PROD_URL:-https://hmv-empleados.nubeportal.com/login}"
APP_BRANCH="${APP_BRANCH:-cursor/ambiente-prod}"
...
TITLE="PROD actualizado"
[[ "${MODE}" == "--test" ]] && TITLE="Ping de prueba — aviso de deploy PROD"
